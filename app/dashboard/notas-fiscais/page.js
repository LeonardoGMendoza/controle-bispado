              ...
              notas.map((nota) => (
                <tr key={nota.id} style={{ borderBottom: '1px solid #eee' }}>
                  ...
                  <td style={{ padding: '12px', textAlign: 'center' }}>
                    {nota.urlAnexo ? (
                      <a href={nota.urlAnexo && nota.urlAnexo.startsWith('/anexos/') ? `/api${nota.urlAnexo}` : nota.urlAnexo} target="_blank" rel="noopener noreferrer" style={{ color: '#005c8a', textDecoration: 'underline', fontSize: '14px', fontWeight: 'bold' }}>
                        Ver Foto
                      </a>
                    ) : (
